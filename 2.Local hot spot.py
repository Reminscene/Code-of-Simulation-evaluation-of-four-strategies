    ...
    while n < vehicle_num:
        while distance < end_distance:
            ...
            for l in neighbor_lst:
                match_prob_lst.append(Matching_prob_df.loc[l, 'matching_prob'])
            max_prob_grid_index = match_prob_lst.index(max(match_prob_lst))
            max_prob_grid_id = neighbor_lst[max_prob_grid_index]
            if matching_state == 0:  # The next location is the grid corresponding to the action.
                next_grid_id = max_prob_grid_id
...
file_save = open('C://Users//张晨皓//Desktop//Simulation evaluation//result//0-1Local hotspot.txt', 'w').close()
file_save_handle = open('C://Users//张晨皓//Desktop//Simulation evaluation//result//0-1Local hotspot.txt', mode='a')
